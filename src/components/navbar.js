        ...
        <div>
            <nav className="menu">
                ...
                <div className="enlace">
                    <a href="/"className="logo">ZAKARIA FATHALLAH</a>
                </div>                                  
                    <ul>
                        <li className="item">
                        ...
                        <li className="item">
                            <a href="mailto:zaakfathallah106@gmail.com" target="_blank" rel="noopener noreferrer">CONTACT</a>
                        </li>
                        <li className="item">
                            <a href="https://www.instagram.com/trulyzaak_106/" target="_blank" rel="noopener noreferrer">
